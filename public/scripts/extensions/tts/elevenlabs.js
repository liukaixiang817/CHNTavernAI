...
class ElevenLabsTtsProvider {
    ...
    get settingsHtml() {
        ...
        <label for="elevenlabs_tts_stability">稳定度: <span id="elevenlabs_tts_stability_output"></span></label>
        <input id="elevenlabs_tts_stability" type="range" value="${this.defaultSettings.stability}" min="0" max="1" step="0.05" />
        <label for="elevenlabs_tts_similarity_boost">相似度提高: <span id="elevenlabs_tts_similarity_boost_output"></span></label>
